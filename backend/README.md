...
## Project Structure
    ...
    ├── testapiautotasksnew_90730  # Django project configurations
...
1. Clone this repo and `cd testapiautotasksnew_90730`
...
2. Clone this repo and `cd testapiautotasksnew_90730`
